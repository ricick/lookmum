package com.lookmum.view 
{
	...
	public class TweenableComponent extends Component implements ITweenableComponent {
		...
		public function rotateXTo(newRotation:Number):void {
			Actuate.tween (this, _rotationDuration, { rotationX:newRotation } ).onUpdate(onUpdate).onComplete(onCompleteRotationTween).ease(_rotationEasing).delay(_delay);
			onStart();
		}
		
		public function rotateYTo(newRotation:Number):void {
			Actuate.tween (this, _rotationDuration, { rotationY:newRotation } ).onUpdate(onUpdate).onComplete(onCompleteRotationTween).ease(_rotationEasing).delay(_delay);
			onStart();
		}
		
		public function rotateZTo(newRotation:Number):void {
			Actuate.tween (this, _rotationDuration, { rotationZ:newRotation } ).onUpdate(onUpdate).onComplete(onCompleteRotationTween).ease(_rotationEasing).delay(_delay);
			onStart();
		}
